 ...
 */
package org.retropipes.dungeondiver7.creature.job.predefined;
...
public class AnnihilatorSpellBook extends SpellBook {
	...
	protected void defineSpells() {
		...
		final var spell0 = new Spell(spell0Effect, 1, BattleTarget.ENEMY, Sounds.COLD_SPELL);
		...
		final var spell1 = new Spell(spell1Effect, 2, BattleTarget.ENEMY, Sounds.FREEZE_SPELL);
		...
		final var spell2 = new Spell(spell2Effect, 3, BattleTarget.ENEMY, Sounds.STEAM_SPELL);
		...
		final var spell3 = new Spell(spell3Effect, 5, BattleTarget.ENEMY, Sounds.MELT_SPELL);
		...
		final var spell4 = new Spell(spell4Effect, 7, BattleTarget.ENEMY, Sounds.FIREBALL_SPELL);
		...
		final var spell5 = new Spell(spell5Effect, 11, BattleTarget.ENEMY, Sounds.EXPLODE_SPELL);
		...
		final var spell6 = new Spell(spell6Effect, 13, BattleTarget.ENEMY, Sounds.WEAKNESS_SPELL);
		...
		final var spell7 = new Spell(spell7Effect, 17, BattleTarget.ENEMY, Sounds.ZAP_SPELL);
