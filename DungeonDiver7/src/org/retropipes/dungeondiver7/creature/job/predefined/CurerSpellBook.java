...
public class CurerSpellBook extends SpellBook {
	...
	protected void defineSpells() {
		...
		final var spell0 = new Spell(spell0Effect, 1, BattleTarget.SELF, Sounds.HEAL_SPELL);
		...
		final var spell1 = new Spell(spell1Effect, 2, BattleTarget.SELF, Sounds.FOCUS_SPELL);
		...
		final var spell2 = new Spell(spell2Effect, 3, BattleTarget.SELF, Sounds.HEAL_SPELL);
		...
		final var spell3 = new Spell(spell3Effect, 5, BattleTarget.SELF, Sounds.FOCUS_SPELL);
		...
		final var spell4 = new Spell(spell4Effect, 7, BattleTarget.SELF, Sounds.HEAL_SPELL);
		...
		final var spell5 = new Spell(spell5Effect, 11, BattleTarget.SELF, Sounds.FOCUS_SPELL);
		...
		final var spell6 = new Spell(spell6Effect, 13, BattleTarget.SELF, Sounds.HEAL_SPELL);
		...
		final var spell7 = new Spell(spell7Effect, 17, BattleTarget.SELF, Sounds.FOCUS_SPELL);
