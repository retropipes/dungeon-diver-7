...
public abstract class AbstractDungeonData implements Cloneable {
        ...
        public abstract boolean isCellDirty(final AbstractDungeon dungeon, final int row, final int col,
                        final int floor);
        ...
        public abstract AbstractDungeonObject getVirtualCell(final AbstractDungeon dungeon, final int row,
                        final int col,
                        final int floor, final int layer);
        ...
        public abstract int linearScanMagnetic(final AbstractDungeon dungeon, final int xIn, final int yIn,
                        final int zIn,
                        final Direction d);
        ...
        public abstract void circularScanRange(final AbstractDungeon dungeon, final int xIn, final int yIn,
                        final int zIn,
        ...
        public abstract void fullScanButtonBind(final AbstractDungeon dungeon, final int dx, final int dy,
                        final int zIn,
                        final AbstractButtonDoor source);

        public abstract void fullScanButtonCleanup(final AbstractDungeon dungeon, final int px, final int py,
                        final int zIn,
        ...
        public abstract void setVirtualCell(final AbstractDungeon dungeon, final AbstractDungeonObject mo,
                        final int row,
                        final int col, final int floor, final int layer);
        ...
        public abstract void updateVisibleSquares(final AbstractDungeon dungeon, final int xp, final int yp,
                        final int zp);
