...
public class WoodenBox extends AbstractMovableObject {
	...
	public Direction laserEnteredAction(final int locX, final int locY, final int locZ, final int dirX, final int dirY,
		...
		if (forceUnits >= this.getMinimumReactionForce()) {
			final AbstractDungeonObject mof = app.getDungeonManager().getDungeon().getCell(locX + dirX, locY + dirY, locZ,
					this.getLayer());
			final AbstractDungeonObject mor = app.getDungeonManager().getDungeon().getCell(locX - dirX, locY - dirY, locZ,
					this.getLayer());
