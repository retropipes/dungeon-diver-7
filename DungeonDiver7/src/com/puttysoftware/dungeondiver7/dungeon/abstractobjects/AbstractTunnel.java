...
public abstract class AbstractTunnel extends AbstractDungeonObject {
	...
	private static void checkTunnelsOfColor(final int color) {
		...
		final int[] pgrmdest = app.getDungeonManager().getDungeon().circularScanTunnel(0, 0, 0, AbstractTunnel.SCAN_RADIUS,
	...
	public boolean pushIntoAction(final AbstractMovableObject pushed, final int x, final int y, final int z) {
		...
		final int[] pgrmdest = app.getDungeonManager().getDungeon().circularScanTunnel(x, y, z, AbstractTunnel.SCAN_RADIUS,
