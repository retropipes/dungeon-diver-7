...
class SystemMonsterSpellBook extends SpellBook {
        ...
        protected void defineSpells() {
                ...
                final var spell0 = new Spell(spell0Effect, 1, BattleTarget.ENEMY, Sounds.DRAIN_SPELL);
                ...
                final var spell1 = new Spell(spell1Effect, 2, BattleTarget.SELF, Sounds.HEAL_SPELL);
                this.spells[1] = spell1;
                final var spell2Effect = new Effect("Weapon Drain", 5);
                spell2Effect.setEffect(Effect.EFFECT_MULTIPLY, StatConstants.STAT_ATTACK, 0.8,
                                Effect.DEFAULT_SCALE_FACTOR,
                ...
                final var spell2 = new Spell(spell2Effect, 3, BattleTarget.ENEMY, Sounds.DEBUFF_1);
                this.spells[2] = spell2;
                final var spell3Effect = new Effect("Armor Drain", 5);
                spell3Effect.setEffect(Effect.EFFECT_MULTIPLY, StatConstants.STAT_DEFENSE, 0.8,
                                Effect.DEFAULT_SCALE_FACTOR,
                                StatConstants.STAT_NONE);
                ...
                final var spell3 = new Spell(spell3Effect, 5, BattleTarget.ENEMY, Sounds.DEBUFF_2);
                ...
                final var spell4 = new Spell(spell4Effect, 7, BattleTarget.SELF, Sounds.BUFF_2);
                ...
                final var spell5 = new Spell(spell5Effect, 11, BattleTarget.SELF, Sounds.BUFF_1);
