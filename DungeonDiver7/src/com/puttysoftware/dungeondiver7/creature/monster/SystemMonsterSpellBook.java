...
class SystemMonsterSpellBook extends SpellBook {
	...
	final var spell0 = new Spell(spell0Effect, 1, BattleTarget.ENEMY, SoundConstants.DRAIN_SPELL);
	...
	final var spell1 = new Spell(spell1Effect, 2, BattleTarget.SELF, SoundConstants.HEAL_SPELL);
	...
	final var spell2 = new Spell(spell2Effect, 3, BattleTarget.ENEMY, SoundConstants.DEBUFF_1);
	...
	final var spell3 = new Spell(spell3Effect, 5, BattleTarget.ENEMY, SoundConstants.DEBUFF_2);
	...
	final var spell4 = new Spell(spell4Effect, 7, BattleTarget.SELF, SoundConstants.BUFF_2);
	...
	final var spell5 = new Spell(spell5Effect, 11, BattleTarget.SELF, SoundConstants.BUFF_1);
