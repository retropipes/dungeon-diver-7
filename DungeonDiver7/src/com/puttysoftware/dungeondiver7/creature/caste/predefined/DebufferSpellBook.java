...
public class DebufferSpellBook extends SpellBook {
        ...
        protected void defineSpells() {
                ...
                spell1Effect.setEffect(Effect.EFFECT_MULTIPLY, StatConstants.STAT_AGILITY, 0.5,
                ...
                spell3Effect.setEffect(Effect.EFFECT_MULTIPLY, StatConstants.STAT_ATTACK, 0,
                                Effect.DEFAULT_SCALE_FACTOR,
                ...
                spell4Effect.setEffect(Effect.EFFECT_MULTIPLY, StatConstants.STAT_ATTACK, 0.5,
                                Effect.DEFAULT_SCALE_FACTOR,
                                StatConstants.STAT_NONE);
                ...
                spell5Effect.setEffect(Effect.EFFECT_MULTIPLY, StatConstants.STAT_DEFENSE, 0,
                                Effect.DEFAULT_SCALE_FACTOR,
                                StatConstants.STAT_NONE);
                ...
                spell6Effect.setEffect(Effect.EFFECT_ADD, StatConstants.STAT_CURRENT_HP, -5,
                                Effect.DEFAULT_SCALE_FACTOR,
                                Effect.DEFAULT_SCALE_STAT);
