...
public class BufferSpellBook extends SpellBook {
        ...
        protected void defineSpells() {
                ...
                spell0Effect.setEffect(Effect.EFFECT_MULTIPLY, StatConstants.STAT_STRENGTH, 2,
                ...
                spell2Effect.setEffect(Effect.EFFECT_MULTIPLY, StatConstants.STAT_VITALITY, 2,
                                Effect.DEFAULT_SCALE_FACTOR,
                                StatConstants.STAT_NONE);
                ...
                spell3Effect.setEffect(Effect.EFFECT_MULTIPLY, StatConstants.STAT_INTELLIGENCE, 2,
                                Effect.DEFAULT_SCALE_FACTOR,
                                StatConstants.STAT_NONE);
