...
public class AnnihilatorSpellBook extends SpellBook {
	...
	final Spell spell0 = new Spell(spell0Effect, 1, BattleTarget.ENEMY, SoundConstants.COLD_SPELL);
	...
	final Spell spell1 = new Spell(spell1Effect, 2, BattleTarget.ENEMY, SoundConstants.FREEZE_SPELL);
	...
	final Spell spell2 = new Spell(spell2Effect, 3, BattleTarget.ENEMY, SoundConstants.STEAM_SPELL);
	...
	final Spell spell3 = new Spell(spell3Effect, 5, BattleTarget.ENEMY, SoundConstants.MELT_SPELL);
	...
	final Spell spell4 = new Spell(spell4Effect, 7, BattleTarget.ENEMY, SoundConstants.FIREBALL_SPELL);
	...
	final Spell spell5 = new Spell(spell5Effect, 11, BattleTarget.ENEMY, SoundConstants.EXPLODE_SPELL);
	...
	final Spell spell6 = new Spell(spell6Effect, 13, BattleTarget.ENEMY, SoundConstants.WEAKNESS_SPELL);
	...
	final Spell spell7 = new Spell(spell7Effect, 17, BattleTarget.ENEMY, SoundConstants.ZAP_SPELL);
