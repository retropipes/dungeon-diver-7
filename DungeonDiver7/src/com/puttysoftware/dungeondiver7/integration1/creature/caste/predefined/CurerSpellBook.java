...
public class CurerSpellBook extends SpellBook {
	...
	final Spell spell0 = new Spell(spell0Effect, 1, BattleTarget.SELF, SoundConstants.HEAL_SPELL);
	...
	final Spell spell1 = new Spell(spell1Effect, 2, BattleTarget.SELF, SoundConstants.FOCUS_SPELL);
	...
	final Spell spell2 = new Spell(spell2Effect, 3, BattleTarget.SELF, SoundConstants.HEAL_SPELL);
	...
	final Spell spell3 = new Spell(spell3Effect, 5, BattleTarget.SELF, SoundConstants.FOCUS_SPELL);
	...
	final Spell spell4 = new Spell(spell4Effect, 7, BattleTarget.SELF, SoundConstants.HEAL_SPELL);
	...
	final Spell spell5 = new Spell(spell5Effect, 11, BattleTarget.SELF, SoundConstants.FOCUS_SPELL);
	...
	final Spell spell6 = new Spell(spell6Effect, 13, BattleTarget.SELF, SoundConstants.HEAL_SPELL);
	...
	final Spell spell7 = new Spell(spell7Effect, 17, BattleTarget.SELF, SoundConstants.FOCUS_SPELL);
