...
public class DebufferSpellBook extends SpellBook {
	...
	final Spell spell0 = new Spell(spell0Effect, 1, BattleTarget.ENEMY, SoundConstants.BOLT_SPELL);
	...
	final Spell spell1 = new Spell(spell1Effect, 2, BattleTarget.ENEMY, SoundConstants.CONFUSION_SPELL);
	...
	final Spell spell2 = new Spell(spell2Effect, 3, BattleTarget.ENEMY, SoundConstants.DUMBFOUND_SPELL);
	...
	final Spell spell3 = new Spell(spell3Effect, 5, BattleTarget.ENEMY, SoundConstants.BUBBLE_SPELL);
	...
	final Spell spell4 = new Spell(spell4Effect, 7, BattleTarget.ENEMY, SoundConstants.DEBUFF_1);
	...
	final Spell spell5 = new Spell(spell5Effect, 11, BattleTarget.ENEMY, SoundConstants.DEBUFF_2);
	...
	final Spell spell6 = new Spell(spell6Effect, 13, BattleTarget.ENEMY, SoundConstants.DRAIN_SPELL);
	...
	final Spell spell7 = new Spell(spell7Effect, 17, BattleTarget.ENEMY, SoundConstants.BLINDNESS);
