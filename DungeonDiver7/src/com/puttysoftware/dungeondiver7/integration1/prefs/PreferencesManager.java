...
public class PreferencesManager {
	...
	return PreferencesManager.storeMgr.getBoolean(PreferencesManager.MUSIC_SETTING, true);
    }

    static void setMusicEnabled(final boolean status) {
	PreferencesManager.storeMgr.setBoolean(PreferencesManager.MUSIC_SETTING, status);
    }
	...
	try (BufferedInputStream bis = new BufferedInputStream(
	    ...
	    PreferencesManager.storeMgr.setBoolean(PreferencesManager.MUSIC_SETTING, true);
