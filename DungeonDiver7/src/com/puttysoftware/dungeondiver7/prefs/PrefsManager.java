...
public class PrefsManager {
	...
	public static int getEditorLayoutID() {
		return PrefsManager.storeMgr.getInteger(
	...
	public static void writePrefs() {
		try (BufferedOutputStream buf = new BufferedOutputStream(
				new FileOutputStream(PrefsManager.getPrefsFile()))) {
	...
	public static void readPrefs() {
		try (BufferedInputStream buf = new BufferedInputStream(
				new FileInputStream(PrefsManager.getPrefsFile()))) {
			...
			PrefsManager.storeMgr.setInteger(
					LocaleLoader.loadString(LocaleConstants.NOTL_STRINGS_FILE,
							LocaleConstants.NOTL_STRING_PREFS_KEY_LANGUAGE_ID),
					PrefsManager.FALLBACK_LANGUAGE_ID);
			PrefsManager.storeMgr.setInteger(
					LocaleLoader.loadString(LocaleConstants.NOTL_STRINGS_FILE,
							LocaleConstants.NOTL_STRING_PREFS_KEY_EDITOR_LAYOUT_ID),
					PrefsManager.DEFAULT_EDITOR_LAYOUT_ID);
