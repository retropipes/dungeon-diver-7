...
public class DungeonObjects {
	...
	private final AbstractDungeonObject[] allObjects = { new UpperGroundEmpty(), new Empty(), new UpperObjectsEmpty(),
			...
			new Party(2), new Party(3), new Party(4), new Party(5), new Party(6), new Party(7), new Party(8), new Party(9),
			new Flag(), new Wall(), new ArrowTurret(), new DeadArrowTurret(), new CrystalBlock(), new Bricks(), new Tunnel(),
			new Mirror(), new RotaryMirror(), new Box(), new ArrowTurretMover(), new TenMissiles(), new MagneticBox(),
			new MagneticMirror(), new MirrorCrystalBlock(), new TenStunners(), new TenBoosts(), new TenMagnets(),
			new MagneticWall(), new FrostField(), new StairsDown(), new StairsUp(), new TenInverseArrows(), new IcyBox(),
	...
	public AbstractDungeonObject readDungeonObjectG2(final XDataReader reader, final int formatVersion) throws IOException {
	...
	public AbstractDungeonObject readDungeonObjectG3(final XDataReader reader, final int formatVersion) throws IOException {
		AbstractDungeonObject o = null;
		String UID = LocaleConstants.COMMON_STRING_SPACE;
	...
	public AbstractDungeonObject readDungeonObjectG4(final XDataReader reader, final int formatVersion) throws IOException {
		AbstractDungeonObject o = null;
		String UID = LocaleConstants.COMMON_STRING_SPACE;
	...
	public AbstractDungeonObject readDungeonObjectG5(final XDataReader reader, final int formatVersion) throws IOException {
		AbstractDungeonObject o = null;
		String UID = LocaleConstants.COMMON_STRING_SPACE;
	...
	public AbstractDungeonObject readDungeonObjectG6(final XDataReader reader, final int formatVersion) throws IOException {
		AbstractDungeonObject o = null;
		String UID = LocaleConstants.COMMON_STRING_SPACE;
