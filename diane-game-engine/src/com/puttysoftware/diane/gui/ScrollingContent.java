...
public final class ScrollingContent extends JScrollPane implements Externalizable {
    private final boolean resizeEnabled;

    protected ScrollingContent(MainContent view) {
	super(view);
	this.resizeEnabled = true;
    }

    protected ScrollingContent(MainContent view, Dimension contentSize) {
	super(view);
