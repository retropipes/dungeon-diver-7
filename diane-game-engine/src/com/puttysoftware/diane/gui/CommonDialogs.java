...
public class CommonDialogs {
  ...
  public static void showDialog(final String msg) {
    JOptionPane.showMessageDialog(MainWindow.owner(), msg, CommonDialogs.DEFAULT_TITLE, JOptionPane.INFORMATION_MESSAGE,
        CommonDialogs.ICON);
  }
  ...
  public static void showTitledDialog(final String msg, final String title) {
    JOptionPane.showMessageDialog(MainWindow.owner(), msg, title, JOptionPane.INFORMATION_MESSAGE, CommonDialogs.ICON);
  }
  ...
  public static void showErrorDialog(final String msg, final String title) {
    JOptionPane.showMessageDialog(MainWindow.owner(), msg, title, JOptionPane.ERROR_MESSAGE, CommonDialogs.ICON);
  }
  ...
  public static String showInputDialog(final String prompt, final String title, final Object[] choices,
    ...
    return (String) JOptionPane.showInputDialog(MainWindow.owner(), prompt, title, JOptionPane.QUESTION_MESSAGE,
  ...
  public static char[] showPasswordInputDialog(final String prompt, final String title, final int length) {
    ...
    panel.add(label);
    panel.add(pass);
    final int option = JOptionPane.showOptionDialog(MainWindow.owner(), panel, title, JOptionPane.OK_CANCEL_OPTION,
  ...
  public static int showConfirmDialog(final String prompt, final String title) {
    return JOptionPane.showConfirmDialog(MainWindow.owner(), prompt, title, JOptionPane.YES_NO_OPTION,
  ...
  public static int showYNCConfirmDialog(final String prompt, final String title) {
    return JOptionPane.showConfirmDialog(MainWindow.owner(), prompt, title, JOptionPane.YES_NO_CANCEL_OPTION,
        JOptionPane.INFORMATION_MESSAGE, CommonDialogs.ICON);
  }

  public static int showCustomDialog(final String prompt, final String title, final String[] buttonNames,
      final String defaultButton) {
    return JOptionPane.showOptionDialog(MainWindow.owner(), prompt, title, JOptionPane.YES_NO_CANCEL_OPTION,
