...
public class VorbisFile {
	 ...
	 * @throws SoundException
	 */
	public VorbisFile(InputStream is, byte[] initial, int ibytes) throws SoundException {
		super();
	...
	void prefetch_all_headers(Info first_i, Comment first_c, int dataoffset) throws SoundException {
		Page og = new Page();
		int ret;
		vi = new Info[links];
