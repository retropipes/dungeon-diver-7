...
public class CloneableObjectStorage {
	...
	if (!(obj instanceof CloneableObjectStorage)) {
	    return false;
	}
	final CloneableObjectStorage other = (CloneableObjectStorage) obj;
     ...
     */
    public final void fill(final CloneableObject obj) {
     ...
     */
    public final CloneableObject getCell(final int... loc) {
     ...
     */
    protected final CloneableObject getRawCell(final int rawLoc) {
     ...
     */
    public final void setCell(final CloneableObject obj, final int... loc) {
	final int aloc = this.ravelLocation(loc);
     ...
     */
    protected final void setRawCell(final CloneableObject obj, final int rawLoc) {
